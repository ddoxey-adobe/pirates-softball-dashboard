              ...
              <div style={{
                ...
                <Card style={{
                  ...
                  {(() => {
                    ...
                    if (roster.length === 0) {
                      return (
                        <div style={{ padding: 20, textAlign: "center", color: THEME.gray, fontSize: 14, marginBottom: 16 }}>
                          No roster loaded for this team. Use manual entry below.
                        </div>
                      );
                    }
                    ...
                    return (
                      <div style={{ marginBottom: 20 }}>
                        ...
                        <div style={{
                          ...
                          {roster
                            .filter(p => p.jersey) // Only show players with jersey numbers
