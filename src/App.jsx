...
const emptyScoutingReport = () => ({
  ...
  location: "",
  notes: "",
  batting: [], // [{ jersey: "", name: "", notes: "", strengths: "", weaknesses: "" }]
  pitching: [], // [{ name: "", speed: "", control: "", pitches: "", notes: "" }]
              ...
              <div>
                ...
                {form.batting.length === 0 ? (
                  <Card style={{ textAlign: "center", padding: 20, background: THEME.black }}>
                    <p style={{ color: THEME.gray, margin: 0 }}>No batters added yet.</p>
                  </Card>
                ) : (
                  <div style={{ display: "grid", gap: 12 }}>
                    {form.batting.map((batter, idx) => (
                      <Card key={idx} style={{ padding: 12, background: THEME.black }}>
                        <div style={{ display: "grid", gridTemplateColumns: "60px 1fr 1fr 1fr 1fr 40px", gap: 8, alignItems: "center" }}>
                          <input
                            type="text"
                            value={batter.jersey}
                          ...
                          <input
                            type="text"
                            value={batter.strengths}
                            onChange={e => updateBatter(idx, "strengths", e.target.value)}
                          ...
                          <input
                            type="text"
                            value={batter.weaknesses}
                            onChange={e => updateBatter(idx, "weaknesses", e.target.value)}
                ...
                {form.pitching.length === 0 ? (
                  ...
                  <div style={{ display: "grid", gap: 12 }}>
                    {form.pitching.map((pitcher, idx) => (
                      <Card key={idx} style={{ padding: 12, background: THEME.black }}>
                        <div style={{ display: "grid", gridTemplateColumns: "1.5fr 1fr 1fr 1.5fr 2fr 40px", gap: 8, alignItems: "center" }}>
                          <input
                            type="text"
                            value={pitcher.name}
                          ...
                          <input
                            type="text"
                            value={pitcher.speed}
                            onChange={e => updatePitcher(idx, "speed", e.target.value)}
                            placeholder="Speed"
                            style={{
                              padding: "8px",
                              background: THEME.blackLight,
                          ...
                          <input
                            type="text"
                            value={pitcher.control}
                            onChange={e => updatePitcher(idx, "control", e.target.value)}
                            placeholder="Control"
                            style={{
                              padding: "8px",
                              background: THEME.blackLight,
                          ...
                          <input
                            type="text"
                            value={pitcher.pitches}
                            onChange={e => updatePitcher(idx, "pitches", e.target.value)}
