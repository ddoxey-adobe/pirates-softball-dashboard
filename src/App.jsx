...
const Scouting = () => {
  ...
  const logPitchToCount = (pitchType) => {
    ...
    if (!selectedJersey.trim()) {
      if (pitchType === "strike" && currentPitchCount.strikes >= 2) {
        alert("Please enter batter jersey number before strike 3");
        return;
      }
      if (pitchType === "ball" && currentPitchCount.balls >= 3) {
        alert("Please enter batter jersey number before ball 4");
        return;
      }
    }
  ...
  const logAtBat = (result) => {
    ...
    const player = roster.find(p => p.jersey === selectedJersey);
  ...
  const logBaserunning = (type) => {
    ...
    if (!jersey) {
      alert("Please enter a jersey number for baserunning");
      return;
    }
    ...
    // Don't clear jersey - they might still be at bat
  };
            ...
            {activeSection === "liveTracking" && (
              <div>
                ...
                <Card style={{ padding: 20, background: THEME.black, marginBottom: 16 }}>
                  ...
                  {/* Batter Jersey */}
                  <div style={{ marginBottom: 16 }}>
                    <div style={{ color: THEME.gray, fontSize: 12, marginBottom: 8, textTransform: "uppercase" }}>Batter Jersey #</div>
                    <input
                      type="text"
                  ...
                  {/* Baserunning Buttons */}
                  <div style={{ marginBottom: 16 }}>
                    <div style={{ color: THEME.gray, fontSize: 12, marginBottom: 8, textTransform: "uppercase" }}>Baserunning</div>
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                      <button
                  ...
                  {/* RBI Selector */}
                  <div>
                    <div style={{ color: THEME.gray, fontSize: 12, marginBottom: 8, textTransform: "uppercase" }}>RBIs (optional)</div>
                    <div style={{ display: "flex", gap: 8 }}>
                      {[0, 1, 2, 3, 4].map(num => (
                        <button
                          key={num}
                          ...
                          style={{
                            ...
                            border: `2px solid ${rbiCount === num ? THEME.gold : THEME.charcoal}`,
                            borderRadius: 6,
                        ...
                        return (
                          <Card key={actualIndex} style={{ padding: 12, background: THEME.black, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                              ...
                              {ab.rbi > 0 && <span style={{ color: THEME.blue, fontSize: 12, fontWeight: 600 }}>{ab.rbi} RBI</span>}
