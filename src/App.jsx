          ...
          >
                  ...
                  {playerBattingStats.slice(0, 5).map((stat, idx) => (
                    <div key={stat.player.id} style={{
                      ...
                      <div style={{ display: "flex", gap: 16, fontSize: 12 }}>
                        <div style={{ textAlign: "center" }}>
                          <div style={{ color: THEME.gold, fontWeight: 700 }}>.{Math.round(stat.avg * 1000)}</div>
            ...
            {selectedGame && (
              <Modal>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                  <div>
                    <h3 style={{ color: THEME.gold, fontSize: 18, fontWeight: 700, fontFamily: "'Oswald',sans-serif", margin: 0 }}>
